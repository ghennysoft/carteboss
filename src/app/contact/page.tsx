...
const Contact = () => {
  ...
  // Gestionnaire pour fermer le menu mobile en redimensionnant
  useEffect(() => {
    const handleResize = () => {
    ...
    <div className="antialiased bg-body text-body font-body">
      ...
      <div>
        <p className="mb-0 py-3 bg-lime-500 text-center">
          ...
          <a href="https://www.pixelrocket.store" className="underline">www.pixelrocket.store</a>
        </p>
      </div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-lg mx-auto">
            <div className="text-center mb-20">
              <h1 className="font-heading text-5xl sm:text-6xl md:text-7xl tracking-sm mb-6">Contact us</h1>
            ...
            <div className="p-8 bg-white rounded-2xl shadow-md">
              <div>
                <form onSubmit={handleSubmit}>
                  ...
                  {/* Service Field */}
                  <label htmlFor="service" className="block pl-4 mb-1 text-sm font-medium">
                    Service
                  </label>
