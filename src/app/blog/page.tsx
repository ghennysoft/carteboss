        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full lg:w-1/2 xl:w-7/12 px-4 mb-8 lg:mb-0">
              <div>
                <img className="block w-full mb-8" src="/fauna-assets/blog/image-lg-post.png" alt="Harnessing the Power of the Sun" />
                <div className="mb-6">
                  <a href="#!" className="inline-block mr-2 px-2 text-sm font-medium hover:bg-gray-50 border rounded-full">Solar Power</a>
                  <a href="#!" className="inline-block px-2 text-sm font-medium hover:bg-gray-50 border rounded-full">Solutions</a>
                </div>
                <a href="#!" className="block group max-w-2xl">
                  ...
                  <div className="flex items-center">
                    <img className="w-10 h-10 rounded-full" src="/fauna-assets/blog/avatar-1.png" alt="Leslie Alexander" />
            ...
            <div className="w-full lg:w-1/2 xl:w-5/12 px-4">
              <div className="max-w-lg">
                {/* Post 1 */}
                <a href="#!" className="flex flex-wrap sm:flex-nowrap group mb-8 items-center">
                  <img className="block" src="/fauna-assets/blog/image-sm-1.png" alt="Wind Power" />
                  <div className="mt-6 sm:mt-0 sm:ml-8">
                    ...
                    <div className="flex items-center">
                      <img className="w-8 h-8 rounded-full" src="/fauna-assets/blog/circle-avatar-1.png" alt="Wade Warren" />
                      <div className="flex items-center ml-4">
                ...
                {/* Post 2 */}
                <a href="#!" className="flex flex-wrap sm:flex-nowrap group mb-8 items-center">
                  <img className="block" src="/fauna-assets/blog/image-sm-2.png" alt="Biomass Energy" />
                  <div className="mt-6 sm:mt-0 sm:ml-8">
                    <h3 className="text-2xl font-medium group-hover:text-teal-600 transition duration-200 mb-6">
                      From Trash to Treasure: The Promising World of Biomass Energy
                    </h3>
                    <div className="flex items-center">
                      <img className="w-8 h-8 rounded-full" src="/fauna-assets/blog/circle-avatar-2.png" alt="Jenny Wilson" />
                      <div className="flex items-center ml-4">
                ...
                {/* Post 3 */}
                <a href="#!" className="flex flex-wrap sm:flex-nowrap group items-center">
                  <img className="block" src="/fauna-assets/blog/image-sm-3.png" alt="Hydrogen Energy" />
                  <div className="mt-6 sm:mt-0 sm:ml-8">
                    <h3 className="text-2xl font-medium group-hover:text-teal-600 transition duration-200 mb-6">
                      Hydrogen: Fueling the Green Energy Revolution
                    </h3>
                    <div className="flex items-center">
                      <img className="w-8 h-8 rounded-full" src="/fauna-assets/blog/circle-avatar-3.png" alt="Leslie Alexander" />
                      <div className="flex items-center ml-4">
                        <span className="text-sm font-medium">Leslie Alexander</span>
                        <span className="mx-2 sm:mx-4">
                          <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Additional Content (Shown when "See all" is clicked) */}
